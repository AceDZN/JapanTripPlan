    ...
    blocks: [
      {
        ...
        detail:
          "מוזמן: ארבעה כרטיסי KYOTO YOKAI FESTIVAL 2026 ליום שלם עם מרצ׳נדייז בלעדי, ¥3,800 לאדם — ¥15,200, כולל חוברת אירוע (יפנית ואנגלית) וגלויה אקראית מתוך שלושה עיצובים לכל אחד. נכנסים עם הפתיחה ומתחילים ברחובות הסטים מעידן אדו. 10:30 Yokai ☆Dance Live (רק בחגים ובסופ״ש), ~11:00 חדר בריחה נינג׳ה (הקופון מכסה את כל הארבעה), ~11:45 מבוך תלת־ממד 3D Maze the Ninja Fort — הקופון מכסה רק שניים, מחליטים מראש מי נכנס או משלימים במקום. 12:15 ארוחת צהריים בתוך הפארק, מסיימים עד 13:15. 14:30 Yokai ☆Dance Live שני, 15:30 Kaikai Greeting, יוצאים ב־15:45. כל ארבעת הכרטיסים הונפקו כ״13 ומעלה״ — זה מעל תעריף הילד, אז השער מקבל אותם גם עבור בן ה־12.",
        booking: {
          label: "מוזמן — ¥15,200 (כניסה)",
      ...
      },
      {
        ...
        placeIds: ["uzumasa-kyoto-village"],
        detail:
          "עוגן קבוע של היום, מוזמן מראש לארבעה. מגיעים מוקדם — חריץ שמפספסים לא מוחזר. הכניסה לכפר היא דרך הסמארטפון בלבד: פותחים את קישור הכרטיס מהמייל בטלפון או משתפים כל כרטיס לטלפון הנכון מראש, ומוודאים שחבילת הגלישה פעילה לפני השער.",
      },
      {
        time: "16:15–18:00",
