...
export const places: Place[] = [
  ...
  },
  {
    ...
    "planned": false,
    "descriptionHe": "תיאטרון מסכות אילם בן 700 שנה — החלפה אופציונלית בלבד למי שמעדיף מסורת על פני יום הסמוראים.",
    "tips": "לוותר בקלות: זה swap ולא תוספת. המופע הסתווי רץ 10–12.10, חמש הצגות בין 13:00 ל־17:30, כניסה ביום עצמו ללא הזמנה. דורש לעזוב את אוזומאסה סביב 13:15.",
