...
export default defineTool({
  description: [
    ...
    "",
    "`status: 'pending'` is for something booked or won but not yet charged — a held",
    "reservation, a lottery win before payment. Use 'paid' only when the money has moved.",
    "",
